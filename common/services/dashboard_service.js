...
define(["require", "exports"], function (require, exports) {
    var DashboardService = (function () {
        ...
        DashboardService._name = 'DashboardService';
        DashboardService.factory = ['$rootScope', '$q', '$http', 'config', function ($rootScope, $q, $http, config) {
            return {
                /*
                 * 管理同好会
                 * */
                list_bas: function (basListQuery) {
                    var promise = $http({
                        method: 'GET',
                 ...
                 *  同好会申请列表
                 * */
                list_ba_applies: function (basListQuery) {
                    var promise = $http({
                        method: 'GET',
                 ...
                 *  审核一个同好会申请
                 * */
                check_a_ba_apply: function (data) {
                    var promise = $http({
                        method: 'POST',
                 ...
                 * 更新了一个链接
                 * */
                update_a_post_link: function (data) {
                    var promise = $http({
                        method: 'POST',
                ...
                add_a_post: function (data) {
                    var promise = $http({
                        ...
                        data: {
                            ...
                            pic_urls: data.pictures.map(function (pic) {
                                return pic['url'];
                            }).join(',')
                        },
                        needToken: true
                 ...
                 * 举报列表
                 * */
                list_report_posts: function (query) {
                    var promise = $http({
                        method: 'GET',
                 ...
                 * 处理一个举报
                 * */
                check_a_report_post: function (data) {
                    var promise = $http({
                        method: 'POST',
                 ...
                 * 列表 首页顶图
                 * */
                list_index_pictures: function (data) {
                    var promise = $http({
                        method: 'GET',
                 ...
                 * 新建一个图片
                 * */
                add_a_index_picture: function (data) {
                    var promise = $http({
                        method: 'POST',
                 ...
                 * 更新图片
                 * */
                update_a_index_picture: function (data) {
                    var promise = $http({
                        method: 'POST',
                 ...
                 * 删除图片
                 * */
                del_a_index_picture: function (data) {
                    var promise = $http({
                        method: 'POST',
                 ...
                 * 上架一个图片
                 * */
                publish_a_index_picture: function (data) {
                    var promise = $http({
                        method: 'POST',
                 ...
                 * 清空一个图片位
                 * */
                clear_a_index_picture_position: function (data) {
                    var promise = $http({
                        method: 'POST',
                 ...
                 * 预览图片
                 * */
                preview_index_pictures: function () {
                    var promise = $http({
                        method: 'GET',
                 ...
                 * 添加一个板块
                 * */
                add_a_bbs_hot_forum: function (data) {
                    var promise = $http({
                        method: 'POST',
                 ...
                 * 删除一个板块
                 * */
                del_a_bbs_hot_forum: function (data) {
                    var promise = $http({
                        method: 'POST',
                 ...
                 * 更新一个板块
                 * */
                update_a_bbs_hot_forum: function (data) {
                    var promise = $http({
                        method: 'POST',
                 ...
                 * 下架板块
                 * */
                off_bbs_hot_forums: function (data) {
                    var promise = $http({
                        method: 'POST',
                 ...
                 * 上架板块
                 * */
                on_bbs_hot_forums: function (data) {
                    var promise = $http({
                        method: 'POST',
                 ...
                 * 添加一个帖子
                 * */
                add_a_bbs_hot_post: function (data) {
                    var promise = $http({
                        method: 'POST',
                 ...
                 * 删除一个帖子
                 * */
                del_a_bbs_hot_post: function (data) {
                    var promise = $http({
                        method: 'POST',
                 ...
                 * 更新一个帖子
                 * */
                update_a_bbs_hot_post: function (data) {
                    var promise = $http({
                        method: 'POST',
                 ...
                 * 下架帖子
                 * */
                off_bbs_hot_posts: function (data) {
                    var promise = $http({
                        method: 'POST',
                 ...
                 * 下架帖子
                 * */
                on_bbs_hot_posts: function (data) {
                    var promise = $http({
                        method: 'POST',
                 ...
                 * 更新一个 发现页推荐同好会
                 * */
                update_a_push_ba: function (data) {
                    var promise = $http({
                        method: 'POST',
                 ...
                 * 发布 发现页推荐同好会
                 * */
                publish_push_bas: function (data) {
                    var promise = $http({
                        method: 'POST',
                ...
                add_a_public_notice: function (data) {
                    var promise = $http({
                        method: 'POST',
                ...
                del_a_public_notice: function (data) {
                    var promise = $http({
                        method: 'POST',
